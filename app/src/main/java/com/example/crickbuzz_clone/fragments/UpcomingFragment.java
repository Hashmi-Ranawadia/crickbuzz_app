...
import com.example.crickbuzz_clone.Adapter.Upcoming_Domestic_Formate_Matches_Adapter;
import com.example.crickbuzz_clone.Adapter.Upcoming_International_Formate_Matches_Adapter;
import com.example.crickbuzz_clone.Adapter.Upcoming_League_Formate_Matches_Adapter;
import com.example.crickbuzz_clone.Adapter.Upcoming_Women_Formate_Matches_Adapter;
...
public class UpcomingFragment extends Fragment {
    ...
    Upcoming_International_Formate_Matches_Adapter upcoming_international_formate_matches_adapter;
    Upcoming_League_Formate_Matches_Adapter upcoming_league_formate_matches_adapter;
    Upcoming_Domestic_Formate_Matches_Adapter upcoming_domestic_formate_matches_adapter;
    Upcoming_Women_Formate_Matches_Adapter upcoming_women_formate_matches_adapter;
                ...
                if(response.isSuccessful()){
                    ...
                    for(int i=0; i<typeMatches.length; i++) {
                        ...
                        if (typeMatches[i].getMatchType().equals("International")) {
                            ...
                            upcoming_international_formate_matches_adapter = new Upcoming_International_Formate_Matches_Adapter(getContext(), typeMatches);
                            recyclerView1.setLayoutManager(new LinearLayoutManager(getContext()));
                            recyclerView1.setAdapter(upcoming_international_formate_matches_adapter);
                        }
                        ...
                        if (typeMatches[i].getMatchType().equals("Domestic")) {
                            ...
                            upcoming_domestic_formate_matches_adapter = new Upcoming_Domestic_Formate_Matches_Adapter(getContext(), typeMatches);
                            recyclerView3.setLayoutManager(new LinearLayoutManager(getContext()));
                            recyclerView3.setAdapter(upcoming_domestic_formate_matches_adapter);
                        }
                        ...
                        if (typeMatches[i].getMatchType().equals("Women")) {
                            ...
                            upcoming_women_formate_matches_adapter = new Upcoming_Women_Formate_Matches_Adapter(getContext(), typeMatches);
                            recyclerView4.setLayoutManager(new LinearLayoutManager(getContext()));
                            recyclerView4.setAdapter(upcoming_women_formate_matches_adapter);
                        }
...
//                    upcoming_league_formate_matches_adapter = new Upcoming_League_Formate_Matches_Adapter(getContext(), typeMatches);
//                    recyclerView2.setLayoutManager(new LinearLayoutManager(getContext()));
//                    recyclerView2.setAdapter(upcoming_league_formate_matches_adapter);
