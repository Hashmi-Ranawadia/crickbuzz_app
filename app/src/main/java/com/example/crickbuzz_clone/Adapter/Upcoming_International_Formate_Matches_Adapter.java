...
import com.example.crickbuzz_clone.model_class.matchInfo;
import com.example.crickbuzz_clone.model_class.typeMatches;

import java.util.ArrayList;

public class Upcoming_International_Formate_Matches_Adapter extends RecyclerView.Adapter<Upcoming_International_Formate_Matches_Adapter.ViewHolder> {

    Context context;
    typeMatches[] typeMatches;
    int newData;

    public Upcoming_International_Formate_Matches_Adapter(Context context, typeMatches[] typeMatches) {
