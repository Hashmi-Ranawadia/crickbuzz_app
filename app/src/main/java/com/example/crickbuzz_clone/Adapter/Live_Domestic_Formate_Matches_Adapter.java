...
public class Live_Domestic_Formate_Matches_Adapter extends RecyclerView.Adapter<Live_Domestic_Formate_Matches_Adapter.ViewHolder> {

    Context context;
    typeMatches[] typeMatches;

    public Live_Domestic_Formate_Matches_Adapter(Context context, typeMatches[] typeMatches) {
