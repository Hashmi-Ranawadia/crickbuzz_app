...
public class Upcoming_Domestic_Formate_Matches_Adapter extends RecyclerView.Adapter<Upcoming_Domestic_Formate_Matches_Adapter.ViewHolder> {

    Context context;
    com.example.crickbuzz_clone.model_class.typeMatches[] typeMatches;
    int newData=0;

    public Upcoming_Domestic_Formate_Matches_Adapter(Context context, typeMatches[] typeMatches) {
