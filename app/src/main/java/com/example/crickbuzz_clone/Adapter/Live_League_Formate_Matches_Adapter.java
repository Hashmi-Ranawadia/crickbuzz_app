...
public class Live_League_Formate_Matches_Adapter extends RecyclerView.Adapter<Live_League_Formate_Matches_Adapter.ViewHolder> {

    Context context;
    com.example.crickbuzz_clone.model_class.typeMatches[] typeMatches;

    public Live_League_Formate_Matches_Adapter(Context context, typeMatches[] typeMatches) {
