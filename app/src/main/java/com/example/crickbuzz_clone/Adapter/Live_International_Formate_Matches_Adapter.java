...
public class Live_International_Formate_Matches_Adapter extends RecyclerView.Adapter<Live_International_Formate_Matches_Adapter.ViewHolder> {

    Context context;
    typeMatches[] typeMatches;

    public Live_International_Formate_Matches_Adapter(Context context, typeMatches[] typeMatches) {
